  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-md p-10 flex flex-col items-center gap-6 w-full max-w-sm">
        <h1 className="text-2xl font-semibold text-gray-800">AudífonosPro</h1>
        ...
        <button
          onClick={signIn}
          disabled={isLoading}
          className="flex items-center gap-3 px-5 py-2.5 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 transition-colors text-gray-700 font-medium shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
        >
          {isLoading ? (
